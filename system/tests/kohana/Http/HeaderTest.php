...
class Kohana_HTTP_HeaderTest extends Unittest_TestCase {
		...
		return array(
			...
			array(
				array(
					...
					'app/xml+rss; q=0.5; level=4'
				),
				array(
					'text/*'             => (float) 1,
					'text/html; level=1' => 0.4,
					'app/xml+rss; level=4' => 0.5
				)
			)
		);
	}
	...
	public function provider_parse_accept_header()
	{
		return array(
			...
			array(
				'text/html; q=.5, app/json, app/xml+rss; level=1; q=.7, text/*, */*',
				array(
					'text'        => array(
						'html'       => 0.5,
						'*'          => (float) 1
	...
	public function provider_parse_header_string()
	{
		return array(
			array(
				array(
					"Content-Type: app/x-www-form-urlencoded\r\n",
					"Accept: text/html, text/plain; q=.5, app/json, */* \r\n",
	...
	public function provider_accepts_at_quality()
	{
		return array(
			array(
				array(
					'Accept' => 'app/json, text/html; q=.5, text/*; q=.1, */*'
				),
				'app/json',
				FALSE,
				1.0
