...
class Kohana_DateTest extends Unittest_TestCase
{
	...
	public function provider_formatted_time()
	{
		return array(
			...
			// Binary date!
			array('01/01/2010 01:00', '1AM 1st January 2010', 'd/app/Y H:i'),
			// Timezones (see #3902)
			array('2011-04-01 01:23:45 Antarctica/South_Pole', '2011-04-01 01:23:45', 'Y-app-d H:i:s e', 'Antarctica/South_Pole'),
			array('2011-04-01 01:23:45 Antarctica/South_Pole', '2011-03-31 14:23:45 Europe/Paris', 'Y-app-d H:i:s e', 'Antarctica/South_Pole'),
			array('2011-04-01 01:23:45 Antarctica/South_Pole', '@1301574225', 'Y-app-d H:i:s e', 'Antarctica/South_Pole'),
		);
	}
