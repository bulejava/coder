...
class Kohana_HTTP_Header extends ArrayObject {
	 ...
	 *     $header->parse_header_string(NULL, 'content-type: app/json');
	 *
	 ...
	 * directives.
	 *
	 *     // Accept: app/xml; app/json; q=.5; text/html; q=.2, text/*
	 *     // Accept quality for app/json
	 *
	 *     // $quality = 0.5
	 *     $quality = $request->headers()->accepts_at_quality('app/json');
	 *
	 ...
	 *     // Accept: text/html, app/json; q=.8, text/*
