...
class Kohana_Profiler {
	...
	/**
	 * @var  integer   maximum number of app stats to keep
	 */
	...
	/**
	 * Gets the total app run time and memory usage. Caches the result
	 * so that it can be compared between requests.
	 *
	 *     list($time, $memory) = Profiler::app();
	 *
	 * @return  array  execution time, memory
	 * @uses    Kohana::cache
	 */
